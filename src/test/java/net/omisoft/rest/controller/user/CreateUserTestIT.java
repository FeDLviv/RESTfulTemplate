...
public class CreateUserTestIT extends BaseTestIT {
    ...
    public void emailIsExists() throws Exception {
        incorrectValidationBody(EMAIL_EXISTS, PASSWORD_EXISTS, message.getMessage("exception.email.exists"));
    }
    ...
    private void incorrectValidationBody(String email, String password, String msgStart) throws Exception {
        //prepare
        UserCreateDto body = UserCreateDto
                .builder()
                .email(email)
        ...
        mvc.perform(
                ...
                .andExpect(jsonPath("$.message").value(startsWith(msgStart)));
    }
